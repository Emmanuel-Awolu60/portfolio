...
const Services: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        'Building robust, scalable server-side solutions to power seamless  experiences.',
    ...
    },
    {
      ...
      title: 'Tech Writer',
      description:
        'Crafting engaging, SEO-optimized content to simplify complex tech concepts.',
    ...
    },
    {
      ...
      description:
        'Driving insights through data research and analysis for informed decisions.',
      buttonText: 'Read More',
    },
    {
      icon: <TbPencilCheck />,
      ...
      title: 'Consulting',
      description:
        'Providing tailored solutions to optimize your business processes and technology stack.',
      buttonText: 'Contact Me',
    },
  ];
